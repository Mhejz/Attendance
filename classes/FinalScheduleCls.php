            ...
            switch ($action) {
                case "SELECT":
                    ...
                    switch ($table_name) {
                        ...
                        case "tblAllFinalScheduleList":
                            $data = [];
                            $query  =   "SELECT * FROM tbl_final_schedule
                            ...
                            while($row = $result->fetch_assoc()) {
                                $data[] =   [
                                    'id'                        =>  $row['id'],
                                    'tbl_subject_schedule_id'   =>  $row['tbl_subject_schedule_id'],
                                    'tbl_students_id'           =>  $row['tbl_students_id'],
